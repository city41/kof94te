...
function createCromBytesFromCanvasContext(
  imgCanvasContext: CanvasRenderingContext2D,
...
function createCromBytes(
  ...
  return createCromBytesFromCanvasContext(
    imgCanvasContext,
    paletteCanvasContext
  );
}

export { createCromBytesFromCanvasContext, createCromBytes };
